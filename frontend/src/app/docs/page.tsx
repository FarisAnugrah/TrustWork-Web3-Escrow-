              ...
              <div className="prose prose-invert max-w-none">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                  <div className="bg-gray-900/50 border border-gray-700 p-6 rounded-xl">
                    <h4 className="text-white font-bold mb-2">1. On-Chain (Solidity)</h4>
                  ...
                  <div className="bg-purple-900/10 border border-purple-500/30 p-6 rounded-xl">
                    <h4 className="text-purple-300 font-bold mb-2">2. Off-Chain (Local/IPFS)</h4>
                    <ul className="list-disc pl-5 text-gray-400 text-sm space-y-2">
                      <li>Project Names</li>
                ...
                <pre className="bg-black border border-gray-800 p-4 rounded-xl text-gray-300 overflow-x-auto text-sm mb-8">
{`struct Milestone {
    uint8 percentage;
    bool isApproved;
}
    ...
    address arbiter;
              ...
              <div className="space-y-12">
                <div className="relative pl-8 md:pl-0">
                  ...
                  <div className="relative flex flex-col md:flex-row gap-8 mb-12">
                    <div className="hidden md:flex absolute left-8 -translate-x-1/2 w-8 h-8 rounded-full bg-black border-4 border-purple-500 items-center justify-center z-10"></div>
                    ...
                    <div className="glass-card p-6 rounded-2xl border border-white/10 w-full bg-black/40">
                      <h4 className="text-xl font-bold text-white md:hidden mb-2">1. Creation</h4>
                      <p className="text-gray-400">The client navigates to the Create page, inputs the worker's wallet address, the total project value in USDC, and defines custom milestone splits. The client signs 2 transactions: Token Approval and Contract Creation.</p>
                    </div>
                  </div>

                  {/* Step 2 */}
                  <div className="relative flex flex-col md:flex-row gap-8 mb-12">
                    <div className="hidden md:flex absolute left-8 -translate-x-1/2 w-8 h-8 rounded-full bg-black border-4 border-blue-500 items-center justify-center z-10"></div>
                    <div className="md:w-64 pt-1 shrink-0 md:text-right md:pr-12 hidden md:block">
                    ...
                    <div className="glass-card p-6 rounded-2xl border border-white/10 w-full bg-black/40">
                      ...
                      <p className="text-gray-400">The worker checks the Dashboard to verify that the project state is <code>ACTIVE</code> and the total value is locked. The worker then proceeds to deliver the off-chain work (e.g., sending code, designs).</p>
                    </div>
                  </div>

                  {/* Step 3 */}
                  <div className="relative flex flex-col md:flex-row gap-8">
                    <div className="hidden md:flex absolute left-8 -translate-x-1/2 w-8 h-8 rounded-full bg-black border-4 border-green-500 items-center justify-center z-10"></div>
                    <div className="md:w-64 pt-1 shrink-0 md:text-right md:pr-12 hidden md:block">
                    ...
                    <div className="glass-card p-6 rounded-2xl border border-white/10 w-full bg-black/40">
                      ...
                      <p className="text-gray-400">The client reviews the work and clicks "Approve Next Milestone". The smart contract automatically calculates the percentage owed and routes the USDC directly to the worker's balance.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {activeTab === 'security' && (
            <div className="animate-in fade-in duration-500">
              ...
              <div className="bg-red-900/10 border border-red-500/30 p-6 rounded-xl mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="glass-card p-6 rounded-xl border border-white/10 bg-black/40">
                  <h4 className="text-white font-bold mb-3">Role-Based Access</h4>
                ...
                <div className="glass-card p-6 rounded-xl border border-white/10 bg-black/40">
                  <h4 className="text-white font-bold mb-3">Mathematical Integrity</h4>
                  <p className="text-gray-400 text-sm leading-relaxed">
              ...
              <div className="glass-card p-8 rounded-2xl border border-white/10 bg-black/40">
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start gap-2">
                    <span className="text-green-400">✓</span> Arbiter can dictate the split percentage (e.g. 70% refund to client, 30% to worker).
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">✗</span> Arbiter <strong>cannot</strong> transfer the funds to their own wallet.
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-red-400">✗</span> Arbiter cannot trigger a dispute. Only the Client or Worker can initiate a freeze.
                  </li>
                </ul>
              </div>
